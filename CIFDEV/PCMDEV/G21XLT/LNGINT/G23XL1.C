/************************************************************************/
/* CCITT G.723 PCM Translator: G23Xl1.c                 V2.00  11/22/93 */
...
/************************************************************************/
/************************************************************************/
int g723_24_decoder (int, int, G2XBLK FAR *);
int g723_24_encoder (int, int, G2XBLK FAR *);

/************************************************************************/
/************************************************************************/
LPITCB FAR PASCAL G23A03toIni (LPITCB lpITC, LPITCI lpIni)
{
...
WORD FAR PASCAL G23A03toITC (_segment _sBufSeg, BYTBASPTR pcSrcBuf, 
...
/************************************************************************/
/*          Convert G.723 bits to 16 bit two's comp waveform value      */
/************************************************************************/
#define BITCNT  3
#define BYTSIZ  8

WORD FAR PASCAL G23A03toG16 (_segment _sBufSeg, BYTBASPTR pcSrcBuf,
...
// modify to accept bit offset from previous pass
    ...
    while (usi) {
        ...
        *_sBufSeg:>psDstBuf++ = g723_24_decoder (usByt & 0xf, 0, &gbG2X);
        usByt >>= BITCNT;
        usBit  -= BITCNT;
    }
...
WORD FAR PASCAL G21G16toA03 (_segment _sBufSeg, GENBASPTR psSrcBuf,
...
WORD FAR PASCAL G23A03toM32 (_segment _sBufSeg, BYTBASPTR pcSrcBuf,
...
WORD FAR PASCAL G21SiltoA03 (BYTE FAR *lpucDstBuf, WORD usBufSiz)
{
 ...
 */
int g723_24_encoder (int sl, int in_coding, struct g72x_state far *state_ptr)
{
 ...
 */
int g723_24_decoder (int i, int out_coding, struct g72x_state far *state_ptr)
{
