/************************************************************************/
/* CCITT G.723 PCM Translator: G23Xl2.c                 V2.00  04/15/95 */
...
/************************************************************************/
/************************************************************************/
int g723_40_decoder (int, int, G2XBLK FAR *);
int g723_40_encoder (int, int, G2XBLK FAR *);

/************************************************************************/
/************************************************************************/
LPITCB FAR PASCAL G23A05toIni (LPITCB lpITC)
{
...
WORD FAR PASCAL G23A05toCmp (_segment _sBufSeg, BYTBASPTR pcSrcBuf, 
...
WORD FAR PASCAL G23G16toA05 (_segment _sBufSeg, GENBASPTR psSrcBuf,
...
WORD FAR PASCAL G23A05toM32 (_segment _sBufSeg, BYTBASPTR pcSrcBuf,
...
WORD FAR PASCAL G23SiltoA05 (BYTE FAR *lpucDstBuf, WORD usBufSiz)
{
 ...
 */
int g723_40_encoder (int sl, int in_coding, struct g72x_state far *state_ptr)
{
 ...
 */
int g723_40_decoder (int i, int out_coding, struct g72x_state far *state_ptr)
{
